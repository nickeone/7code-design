...
const POSTS = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: "p-html", text: "Fixed-price contracts work well for well-defined deliverables but poorly for AI work where scope evolves. <a href=\"https://www.standishgroup.com/sample_research_files/CHAOSReport2021.pdf\" target=\"_blank\" rel=\"noopener noreferrer\">The Standish Group's CHAOS Report</a> found that 66% of software projects with fixed budgets experienced scope changes — for AI projects, that figure is significantly higher." },
