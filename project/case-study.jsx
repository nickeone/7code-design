...
const CASES = {
  ...
  "numerize": {
    ...
    next: { slug: "lendit", client: "Lendit", title: "Peer-to-peer rental marketplace for local communities", kind: "cyan" },
  },
  "lendit": {
    slug: "lendit",
    client: "Lendit", industry: "Marketplace / Sharing Economy", year: "2025",
    duration: "Ongoing, since Nov 2025", team: "1 PM · 1 architect · 1 designer · 1 web engineer · 1 mobile engineer · 1 back-end engineer",
    region: "United Kingdom", kind: "cyan",
    ...
    challenge: {
      ...
      pains: [
        "Creating a recognisable, distinctive brand image from initial inspiration sources",
        "A frictionless but secure payment flow between lenders and borrowers",
        "One consistent experience across web, mobile, and AI-powered services",
        "A backend capable of capturing extensive user-behaviour data from day one",
      ],
    },
    approach: {
      eyebrow: "Our approach",
      ...
      pillars: [
        { title: "Brand and design system", desc: "A recognisable brand built from the founders' initial inspiration, extended into one comprehensive design system shared by web and mobile." },
        { title: "Web and mobile as one product", desc: "A web app for browsing, listing, and managing rentals, plus an iOS and Android app for on-the-go discovery and messaging, same flows, same language." },
        { title: "Verified, secure payments rail", desc: "Stripe payments between lenders and borrowers with Ondato KYC, so identity checks and money movement sit inside the same trusted flow." },
        { title: "A backend built for behavioural data", desc: "Nest.js services on AWS powering listings, search, payments, and KYC, capturing the extensive behavioural data Lendit needs for community insight." },
      ],
    },
    results: [
      { v: "Web + mobile", l: "platform live", sub: "browser, iOS, and Android" },
      { v: "10", l: "modules shipped", sub: "from Explore to Payment" },
      { v: "Stripe", l: "payments + Ondato KYC", sub: "verified lenders and borrowers" },
      { v: "Ongoing", l: "development partnership", sub: "continuous delivery with the Lendit team" },
    ],
    testimonial: {
...
function PhoneMockup({ accent = "var(--cyan-500)" }) {
  ...
  if (CSD.slug === "lendit") {
    return (
      <div className="csd-phone csd-phone--shot">
        <div className="csd-phone-notch"/>
        <img className="csd-phone-img" src="/project/uploads/lendit-mobile.jpg" alt="Lendit mobile app explore screen, browse tools to borrow near you"/>
      </div>
    );
  }
  return (
...
function BrowserMockup({ kind = "calendar" }) {
  ...
  />;
  if (CSD.slug === "lendit") return <PhotoHero
