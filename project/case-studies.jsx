...
const CS_ITEMS = [
  ...
  { slug: "wholesum",           kind: "cyan",     num: "07", year: "2025", client: "WholeSum",           title: "Self-serve AI analytics platform for unstructured text",   meta: ["Data / AI",   "16 weeks"], result: "Launched on time, raised funding", metric: { v: "On time", l: "launch & funding" }, excerpt: "Upload surveys, reviews, and interviews and get structured, AI-powered insights — built end-to-end on Next.js, Nest.js, and AWS." },
  { slug: "daily8",             kind: "cyan",     num: "08", year: "2022", client: "Daily8",             title: "AI-powered news aggregator for the MENA region",           meta: ["Mobile / Media", "6 months"], result: "Shipped iOS + Android in 6 months", metric: { v: "iOS + Android", l: "stores ready" }, excerpt: "News, podcasts, and videos tailored by interest and country — moderated, summarised, and surfaced by AI on React Native + AWS Lambda + OpenAI." },
  { slug: "revote",             kind: "defence",  num: "09", year: "2023", client: "Eurel International", title: "Remote electronic voting platform for the European Parliament", meta: ["E-Government", "8 months"], result: "Released May 2023 to the EU Parliament", metric: { v: "EU Parliament", l: "live deployment" }, excerpt: "Modern remote voting for MEPs across the EU — five modules, EP-grade infrastructure, eight months from discovery to release. Partner: Eurel International." },
  { slug: "g42-fleet",          kind: "energy",   num: "10", year: "2022", client: "Group 42 (G42)",     title: "Real-time fleet tracking platform for EXPO 2020 Dubai",     meta: ["IoT / Smart Buildings", "2 years"], result: "Deployed for EXPO 2020 Dubai", metric: { v: "EXPO 2020", l: "deployed at scale" }, excerpt: "Custom TCP ingestion, geofence rules, real-time map and trip playback — built for the world's largest expo on React Native + Node.js." },
  { slug: "cloud-of-legacy",    kind: "cyan",     num: "11", year: "2024", client: "Cloud of Legacy",    title: "Cloud-based digital-heritage platform with secure inheritance access", meta: ["Consumer SaaS", "8 months"], result: "MVP launched", metric: { v: "MVP", l: "launched in 8 months" }, excerpt: "Subscription cloud where users designate two heirs who can access documents, photos, and credit cards after death — Next.js, React, Keycloak, 2FA." },
  { slug: "lidl-road-safety",   kind: "cyan",     num: "12", year: "2022", client: "Lidl Romania",       title: "Children's road-safety gamification web app for Lidl Romania", meta: ["Education / Retail CSR", "Ongoing"], result: "8th edition running with Romanian Police", metric: { v: "8 editions", l: "annual programme" }, excerpt: "Public + private web app for kids and parents — episodes, levels, quizzes, gamification — built with Lidl and the Romanian Police." },
  { slug: "founders-factory",   kind: "finance",  num: "13", year: "2024", client: "Founders Factory",   title: "UI overhaul + ongoing engineering for a UK venture studio",   meta: ["Venture Studio / VC", "Ongoing"], result: "Bug-free Tailwind migration, Version 6 live", metric: { v: "Tailwind", l: "migrated foundation" }, excerpt: "Cleared the inherited bug backlog, migrated foundersfactory.com from base CSS to Tailwind on Gatsby + Storyblok, and now ship new components on demand." },
];
