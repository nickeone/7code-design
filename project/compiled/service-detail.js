...
const SERVICES_DATA = {
  "ai-product-engineering": {
    ...
    faqs: [{
      q: "What is AI product engineering?",
      ...
      q: "How does 7code approach AI product development?",
      a: "7code follows a structured, outcome-first process: discovery to define business goals, architecture design, iterative build sprints, evaluation loops to validate AI behaviour, and production hardening. Senior engineers lead every engagement. We measure success by business outcomes — cost reduction, revenue impact, or efficiency gains — not just technical delivery."
    }, {
      q: "What technologies does 7code use for AI product engineering?",
      a: "7code builds with Python, FastAPI, and Node.js for backend services; React and Next.js for frontends; OpenAI, Anthropic Claude, and open-source LLMs for AI layers; Pinecone, Weaviate, and pgvector for vector storage; and AWS, GCP, or Azure for cloud infrastructure. Stack choices are always driven by the client’s existing environment and scalability requirements."
    }, {
      q: "How long does an AI product build typically take?",
      a: "A minimum viable AI product typically takes 8–16 weeks from discovery to first production release. Complexity, integration requirements, and the maturity of the client’s data infrastructure all affect timeline. 7code uses time-boxed sprints with clear milestones, so clients see working software every two weeks rather than waiting months for a big reveal."
    }, {
      q: "What is the minimum engagement size for AI product engineering?",
      a: "Contact office@7code.ro to discuss scope and fit. Smaller exploratory engagements — such as a Discovery Sprint or AI Readiness Audit — are available as entry points before committing to a full build."
    }, {
      q: "Can 7code take a product from idea to production?",
      a: "Yes. 7code handles the full product lifecycle: requirements definition, technical architecture, UI/UX design integration, AI model selection, backend and frontend engineering, QA, deployment, and post-launch support. Clients can engage 7code at any stage — from greenfield concept to taking over an existing codebase that needs AI capabilities added."
    }, {
      q: "How does 7code handle AI product validation and testing?",
      a: "7code uses a multi-layer testing approach: unit and integration tests for conventional code, plus AI-specific evaluation frameworks to measure model accuracy, hallucination rates, and output consistency. We build eval suites during development so performance regressions are caught before production. Human-in-the-loop review gates are included for high-stakes decision paths."
    }, {
      q: "What does a typical AI product engineering team look like at 7code?",
      a: "A typical team comprises one AI architect, two to three senior backend engineers, one frontend engineer, and a QA specialist. For larger products, a product manager and DevOps engineer are added. 7code does not staff junior engineers on client projects — all roles are senior or above."
    }],
    resourceLinks: [{
      text: "Read our guide to AI-native product engineering",
      url: "/resources/ai-native-product-engineering"
    }, {
      text: "Build AI in-house or partner? Read our framework",
      url: "/resources/build-ai-in-house-vs-partner"
    }],
    next: {
  ...
  "system-integrations": {
    ...
    faqs: [{
      q: "What types of system integrations does 7code build?",
      a: "7code builds integrations across the full enterprise technology stack: API-to-API integrations between SaaS platforms, ERP and CRM connectors, HRIS integrations, payment gateway connections, IoT data ingestion pipelines, and custom middleware layers where off-the-shelf connectors cannot meet performance or compliance requirements."
    }, {
      q: "Which APIs, ERPs, and CRMs does 7code have experience integrating?",
      a: "7code has integration experience with Salesforce, HubSpot, Pipedrive, SAP S/4HANA, Microsoft Dynamics, NetSuite, Workday, BambooHR, Stripe, Adyen, Xero, QuickBooks, and a range of healthcare-specific systems including HL7 FHIR-compliant EHRs. For less common systems, 7code conducts a Connector Feasibility Review before committing to a timeline."
    }, {
      q: "How long does a typical system integration project take?",
      a: "A straightforward API-to-API integration between two well-documented SaaS platforms typically takes three to six weeks. ERP integrations with custom data transformation requirements run six to twelve weeks. Complex multi-system integration programmes are scoped individually. 7code provides a fixed-scope Discovery phase before full-project commitment."
    }, {
      q: "Who maintains integrations after they are built?",
      ...
      q: "Should I use an iPaaS platform or custom integration code?",
      a: "iPaaS platforms (MuleSoft, Boomi, Make, Zapier) suit commodity integrations between common SaaS tools where volume is moderate and logic is simple. Custom integration code is warranted when performance requirements exceed iPaaS limits, data transformations are complex, compliance requires full audit trails, or total cost of ownership favours build-once over recurring licence fees."
    }, {
      q: "What is the typical size of a system integration project at 7code?",
      a: "Integration projects at 7code range from focused three-week point-to-point connectors to multi-month enterprise integration programmes spanning ten or more systems. Most client engagements sit in the six-to-twelve-week range. 7code is equally comfortable with targeted integrations and large-scale integration architecture — scope and team size are matched to the actual requirement."
    }],
    next: {
      slug: "ai-automation",
  ...
  "ai-automation": {
    ...
    faqs: [{
      ...
      q: "How quickly can businesses see ROI from AI process automation?",
      a: "Most SME automation projects reach payback within 6–18 months, depending on the volume of work automated and the cost of manual effort replaced. Quick-win automations — such as invoice processing or report generation — can show positive ROI within the first quarter. 7code always models expected ROI before project start so clients have a clear business case."
    }, {
      q: "What are the most common AI process automation use cases?",
      a: "The most in-demand use cases include invoice and document processing, customer query triage and response, HR onboarding workflows, compliance monitoring, financial reporting, and supply chain exception management. 7code has delivered automation projects across healthcare, finance, energy, logistics, and HR — adapting each solution to the client’s existing systems and compliance requirements."
    }, {
      q: "Which industries benefit most from AI process automation?",
      a: "Finance and insurance benefit from automated compliance checks and report generation. Healthcare gains from clinical documentation and patient triage automation. Energy companies automate meter data processing and anomaly detection. HR teams use AI to screen candidates and automate onboarding. Operations-heavy businesses in logistics and manufacturing automate exception handling and supplier communication."
    }, {
      q: "How does 7code integrate AI automation with existing business systems?",
      a: "7code maps existing workflows first, then designs automation layers that connect to your current tools — ERP, CRM, HRIS, or custom databases — via APIs, webhooks, or direct database connectors. We prioritise non-disruptive integration: automation runs alongside existing systems initially, with migration to automated workflows happening in controlled phases to minimise operational risk."
    }, {
      q: "How is AI process automation different from traditional RPA?",
      ...
      q: "Who maintains AI automation systems after go-live?",
  ...
  "cloud-agentic-infra": {
    ...
    faqs: [{
      q: "What is cloud agentic infrastructure?",
      ...
      q: "Which cloud providers does 7code support for agentic infrastructure?",
      a: "7code designs and deploys agentic infrastructure on AWS, Google Cloud Platform, and Microsoft Azure. For clients with existing cloud commitments, 7code works within the incumbent provider. Multi-cloud and hybrid architectures — where sensitive model inference stays on-premises while orchestration runs in the cloud — are supported for regulated industries."
    }, {
      q: "Why does AI require specialised cloud infrastructure?",
  ...
  "ai-outstaffing": {
    ...
    faqs: [{
      ...
      q: "How is AI outstaffing different from staff augmentation?",
      a: "The terms are often used interchangeably, but there is a meaningful distinction. Staff augmentation typically implies adding individuals to supplement a project. AI outstaffing, as 7code practises it, means placing a pre-formed, AI-specialised team that operates with continuity, shared technical standards, and peer review — not a collection of individual contractors working in isolation."
    }, {
      q: "What does an AI outstaffing team from 7code typically include?",
      a: "A typical outstaffing team includes one to three senior AI/ML engineers, optionally an AI architect for system design decisions, and a QA engineer for AI evaluation. Team composition is adjusted to the client’s backlog and roadmap. 7code does not outstaff junior engineers — every placed engineer has a minimum of five years of relevant professional experience."
    }, {
      q: "How quickly can 7code place an AI outstaffing team?",
  ...
  "llm-agent-development": {
    ...
    faqs: [{
      ...
      q: "How much does it cost to build an LLM agent?",
      a: "Costs depend on scope and complexity. 7code provides fixed-price Discovery Sprints so clients understand architecture and cost before committing to the full build. Contact office@7code.ro for a scoped estimate."
    }, {
      q: "How long does it take to build an LLM agent?",
      a: "A production-ready single-purpose LLM agent typically takes four to eight weeks to build, including discovery, architecture, development, evaluation, and deployment. Multi-agent systems or agents requiring deep integration with enterprise systems may take twelve to twenty weeks. 7code uses two-week sprint cycles with working demos at the end of each sprint."
    }, {
      q: "What is the difference between prompt engineering and fine-tuning for LLM agents?",
      a: "Prompt engineering shapes model behaviour through careful instruction design — it is fast, cheap, and reversible. Fine-tuning retrains a model on domain-specific data to bake in specialised knowledge or style — it is slower, more expensive, and harder to iterate. 7code defaults to prompt engineering and RAG for most business cases, reserving fine-tuning for when retrieval cannot meet accuracy requirements."
    }, {
      q: "How does 7code handle hallucination and safety in LLM agent systems?",
      ...
      q: "What are multi-agent systems and when does 7code recommend them?",
      a: "Multi-agent systems are architectures where multiple specialised AI agents collaborate — one researches, one writes, one validates — coordinated by an orchestrator. 7code recommends multi-agent designs when tasks are too complex for a single agent, when parallel processing is needed for speed, or when separation of concerns reduces hallucination risk in high-stakes workflows."
    }, {
      q: "Which LLM does 7code recommend — OpenAI, Anthropic, or open-source?",
      a: "Model selection depends on the use case. OpenAI GPT-4o suits broad reasoning and tool use. Anthropic Claude excels at long-context tasks and safety-critical applications. Open-source models (Llama, Mistral) are preferred when data must remain on-premises or costs at scale demand it. 7code is model-agnostic and selects based on accuracy, cost, latency, and compliance requirements."
    }],
    next: {
      slug: "cloud-agentic-infra",
      title: "Cloud & Agentic Infrastructure"
...
function ServiceDetailPage({
  ...
  }, svc.summary), svc.resourceLinks && svc.resourceLinks.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 20,
      display: "flex",
  ...
  }, svc.resourceLinks.map((rl, i) => /*#__PURE__*/React.createElement("a", {
    key: i,
    href: rl.url,
    style: {
      color: "var(--cyan-600)",
  ...
  }, rl.text, " \u2192")))))), /*#__PURE__*/React.createElement("section", {
    className: "section"
  }, /*#__PURE__*/React.createElement("div", {
    className: "container"
  }, /*#__PURE__*/React.createElement("div", {
