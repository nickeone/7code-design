...
// Nav
// ──────────────────────────────────────────────────────────────────
function NavLinkA({ to, children, className = "nav-link", activeClass = "is-active" }: { to: string; children: any; className?: string; activeClass?: string }) {
...
function Nav() {
  ...
  const megaTimer = useRef<any>(null);
  const svcTimer = useRef<any>(null);
