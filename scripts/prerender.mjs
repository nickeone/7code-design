...
const SERVICES = [
  {"slug":"ai-product-engineering","title":"AI-Native Product Engineering","description":"AI-native product engineering by 7Code. We design and ship LLM-powered web and mobile products end-to-end, agents, RAG, evals, and the cloud infrastructure to run them in production."},
  {"slug":"system-integrations","title":"System Integrations","description":"System integrations by 7Code. We connect ERPs, CRMs, SaaS tools, data warehouses, and legacy systems into a single reliable data fabric, built to carry AI workloads on top."},
  {"slug":"ai-automation","title":"AI & Process Automation","description":"AI & process automation by 7Code. RAG copilots, agentic workflows, and LLM integrations grounded in your data, evaluated rigorously, and shipped to production in six weeks."},
  {"slug":"cloud-agentic-infra","title":"Cloud & Agentic Infrastructure","description":"Cloud and agentic infrastructure by 7Code. AWS, GCP, and Azure foundations for AI products, agent pipelines (LangGraph, Temporal), vector stores, eval CI, and cost optimisation."},
  {"slug":"ai-outstaffing","title":"AI Engineering Outstaffing","description":"AI engineering outstaffing by 7Code. Senior AI and ML engineers, production LLM, RAG, and MLOps experience, embedded in your team in 72 hours. Monthly rolling, no lock-in."},
  {"slug":"product-strategy","title":"Product Strategy & Design","description":"Product strategy and design by 7Code. Discovery to design system for AI-native products, UX patterns for streaming, confidence, and fallback paths. Figma and code, ready to ship."},
];

const EXPERTISE = [
  {"slug":"healthcare","title":"Healthcare","description":"HealthTech engineering by 7Code. HIPAA + GDPR-compliant clinical platforms, EHR (HL7 / FHIR) interoperability, telehealth, patient engagement, and AI-grounded clinical support, built end-to-end for clinics, hospitals, and FemTech / FertilityTech founders."},
  {"slug":"finance","title":"Finance","description":"FinTech and finance software engineering by 7Code. Real-time treasury dashboards, ERP integration (SAP, Oracle, NetSuite), accounting automation, regulatory reporting, payments, and venture/MarTech platforms for VCs."},
  {"slug":"energy","title":"Energy & Utilities","description":"Energy, utilities, and IoT software engineering by 7Code. SCADA / Modbus / MQTT ingestion, predictive maintenance, real-time operations cockpits, geofencing, and grid optimisation, built for 24/7 critical infrastructure."},
  {"slug":"defence","title":"Defence & Security","description":"Defence, security, and GovTech / E-Government engineering by 7Code. Mission-critical platforms with multi-domain fusion, information assurance, secure remote-voting (built for the European Parliament), and after-action review tooling."},
  {"slug":"hr","title":"HR","description":"HR Tech engineering by 7Code. ATS / HRIS integration (Workday, SAP SuccessFactors, BambooHR), recruitment and onboarding workflows, payroll automation, workforce analytics, and compliance reporting (EEO, GDPR, local labour law)."},
  {"slug":"operations","title":"Operations","description":"Operations software engineering by 7Code. Workflow automation, real-time operations dashboards, OCR-driven document pipelines, systems integration, and process intelligence, for teams that have outgrown spreadsheets, Slack, and heroic individuals."},
];

const CASES = [
  {"slug":"wholesum","title":"WholeSum: Self-serve AI analytics for unstructured text","description":"Self-serve AI analytics platform for unstructured text by 7Code. Built end-to-end on Next.js + Nest.js + AWS for WholeSum (UK), 16-week design and build, launched on time and raised funding."},
  {"slug":"daily8","title":"Daily8: AI-powered news aggregator for the MENA region","description":"AI-powered news aggregator for the MENA region by 7Code. Daily8 (UAE), live at daily8.com/en, with React Native mobile, web, AI moderation, daily wrap-up, and unbiased opinion on AWS Lambda + OpenAI. Shipped iOS + Android in 6 months."},
  {"slug":"revote","title":"ReVote: Remote electronic voting for the European Parliament","description":"Remote electronic voting platform for the European Parliament, built by 7Code with Eurel International. Secure multi-device voting on the EP network, five modules, eight months, released May 2023."},
  {"slug":"g42-fleet","title":"G42 Fleet: Real-time fleet tracking for EXPO 2020 Dubai","description":"Real-time IoT fleet tracking for EXPO 2020 Dubai by 7Code, partnered with Group 42 (G42, UAE). Custom TCP ingestion, geofence rules, real-time map, and trip playback, 18 months build + 6 months maintenance."},
  {"slug":"cloud-of-legacy","title":"Cloud of Legacy: Digital-heritage with secure inheritance access","description":"Cloud-based digital-heritage platform for Cloud of Legacy (Germany), built by 7Code in 8 months on Next.js + React + Keycloak with 2FA. Subscription cloud where users designate two heirs."},
  {"slug":"lidl-road-safety","title":"Lidl Road Safety: Children's gamification web app","description":"Children's road-safety gamification web app for Lidl Romania and the Romanian Police, built by 7Code on React + Nest.js + Heroku in 6 months. Public + private split, episodes, levels, and a points engine."},
  {"slug":"hera","title":"Hera: AI patient-support app for fertility clinics","description":"AI-powered patient-support app for fertility clinics, built by 7Code for Hera Health Tech (UAE). FemTech / FertilityTech MVP on React Native + Serverless on AWS Lambda, LlamaIndex RAG over verified clinical content, HIPAA + GDPR compliant. Shipped in 3 months."},
  {"slug":"melsonic","title":"Melsonic: AI-powered guitar-learning with real-time feedback","description":"AI-powered guitar-learning web app for Melsonic (UK) by 7Code. Real-time Web Audio API capture, pixi.js canvas rendering, and AI scoring against the original, built on Next.js + Nest.js + PostgreSQL + AWS. Music EdTech MVP shipped in 5 months."},
  {"slug":"drum-bun","title":"Drum Bun: Mobile car-services app for Romanian drivers","description":"Romanian InsurTech mobile app (Drum Bun) for Explorom, built by 7Code on React Native + Node.js + Heroku with an OCR document pipeline. Verify and purchase RCA, ITP, and road vignette in one tap, live on App Store and Play Store."},
  {"slug":"numerize","title":"Numerize: EDM platform with OCR and digital signatures","description":"Responsive electronic document management (GED / EDM) and e-signature platform for Numerize (France), built by 7Code on React + Material-UI + Laravel + AWS. OCR-trained invoice pipeline, YouSign multi-signatories e-signatures, Stripe + 3D Secure billing across 6,000+ enterprise accounts."},
];
